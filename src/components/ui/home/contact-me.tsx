...
const UITitle = ({ title, href }: { title: string; href: string }) => (
  <div className="text-center mb-12 lg:mb-20 relative px-4">
    <div className="relative">
      <div className="flex items-center justify-center gap-2 sm:gap-4 mb-4 sm:mb-6">
        <div className="h-px bg-gradient-to-r from-transparent via-blue-400 to-transparent flex-1 max-w-10 sm:max-w-20"></div>
        <Sparkles className="w-4 h-4 sm:w-6 sm:h-6 text-blue-400 animate-pulse" />
        <div className="h-px bg-gradient-to-r from-transparent via-purple-400 to-transparent flex-1 max-w-10 sm:max-w-20"></div>
      </div>

      <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent mb-2 sm:mb-4 tracking-tight">
      ...
      <div className="mt-4 sm:mt-6 w-20 sm:w-32 h-1 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 mx-auto rounded-full shadow-lg shadow-purple-400/30"></div>
    </div>
  </div>
)
...
const socialLinks: SocialLink[] = [
  {
    name: "GitHub",
    href: "https://github.com/mahmoud-ramadn", // ✅ your real GitHub
    icon: <SiGithub className="w-5 h-5 sm:w-7 sm:h-7" />,
    color: "hover:text-white",
    hoverColor: "hover:shadow-white/20",
  },
  {
    name: "LinkedIn",
    href: "https://linkedin.com/in/mahmoud-ramadan-aa4b322a5/", // ✅ your LinkedIn
    icon: <SiLinkedin className="w-5 h-5 sm:w-7 sm:h-7" />,
    color: "hover:text-[#0077B5]",
    hoverColor: "hover:shadow-blue-500/30",
  },
  {
    name: "X",
    href: "https://x.com/Mahmoud122693", // ✅ your Twitter/X
    icon: <SiX className="w-5 h-5 sm:w-7 sm:h-7" />,
    color: "hover:text-white",
...
const contactInfo: ContactInfo[] = [
  {
    label: "Email",
    value: "mahmoudramdan2000135@gmail.com", // ✅ stays the same
    icon: <Mail className="w-5 h-5 sm:w-6 sm:h-6" />,
    href: "mailto:mahmoudramdan2000135@gmail.com",
  },
  {
    label: "Phone",
    value: "+201067958518", // ✅ replace with your Egyptian phone number
    icon: <Phone className="w-5 h-5 sm:w-6 sm:h-6" />,
    href: "tel:+201067958518",
  },
  {
    label: "Location",
    value: "Damietta, Egypt", // ✅ replace with your real city
...
export default function EnhancedContactUI() {
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      // Method 1: Try using Formspree (free form handling service)
      // You'll need to create a free account at https://formspree.io and get your form ID
      ...
      try {
        ...
        // Show success message after attempting mailto
        setTimeout(() => {
          setSubmitStatus("success")
          setFormData({ name: "", email: "", message: "" })
        }, 500)
    ...
    <div className=" text-white relative overflow-hidden">
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 mt-12 lg:mt-20">
            {/* Contact Information - 1 column on desktop */}
            <div className="lg:col-span-1 space-y-6 sm:space-y-8">
              <div className="relative group">
                <div className="relative bg-gradient-to-br from-gray-900/90 via-gray-800/50 to-gray-900/90 backdrop-blur-2xl border border-gray-700/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 hover:border-gray-600/60 transition-all duration-500 hover:transform hover:scale-[1.02]">
                  ...
                  <div className="space-y-6 sm:space-y-8">
                    {contactInfo.map((info, index) => (
                      <div key={index} className="flex items-center space-x-4 sm:space-x-6 group/item">
                        <div className="relative">
                          <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-xl sm:rounded-2xl blur-md group-hover/item:blur-lg transition-all duration-300"></div>
                          <div className="relative flex-shrink-0 p-3 sm:p-4 lg:p-5 rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/20 group-hover/item:border-blue-400/40 group-hover/item:bg-blue-500/20 transition-all duration-300 group-hover/item:scale-110">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-xs sm:text-sm text-gray-400 uppercase tracking-wider font-semibold mb-1">
                            {info.label}
                          </p>
                          {info.href ? (
                            <a
                              href={info.href}
                              className="text-white hover:text-blue-400 transition-colors font-semibold text-sm sm:text-base lg:text-lg flex items-center gap-2 group/link break-all"
                            >
              ...
              <div className="lg:hidden">
                <div className="relative bg-gradient-to-br from-gray-900/90 via-gray-800/50 to-gray-900/90 backdrop-blur-2xl border border-gray-700/50 rounded-2xl p-6">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {socialLinks.map((social, index) => (
                      <a
                        ...
                        className={cn(
                          "group/social relative flex flex-col items-center justify-center p-4 rounded-xl border border-gray-700/50 bg-gray-800/20 backdrop-blur-sm transition-all duration-500 hover:border-gray-500/50 hover:bg-gray-700/30 hover:scale-105 transform-gpu",
                          social.color,
                          social.hoverColor
                        )}
                      >
                        <div className="relative mb-2 transition-all duration-500 group-hover/social:scale-110">
                          {social.icon}
                        </div>
                        <span className="relative text-xs font-semibold text-gray-300 group-hover/social:text-white transition-colors duration-300">
                          {social.name}
                        </span>
                      </a>
                    ))}
            ...
            <div className="lg:col-span-2 space-y-6 sm:space-y-8">
              <div className="relative group">
                <div className="relative bg-gradient-to-br from-gray-900/90 via-gray-800/50 to-gray-900/90 backdrop-blur-2xl border border-gray-700/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 hover:border-gray-600/60 transition-all duration-500">
                  <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8 lg:mb-10">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                    ...
                    <div className="relative">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          required
                          className="w-full pl-12 pr-4 py-3 sm:py-4 bg-gray-800/50 border border-gray-600/50 rounded-xl focus:outline-none focus:border-blue-400/60 focus:bg-gray-800/70 transition-all duration-300 text-white placeholder-gray-400 text-sm sm:text-base"
                    ...
                    <div className="relative">
                      ...
                      <div className="relative">
                        ...
                        <textarea
                          ...
                          required
                          rows={6}
                          className="w-full pl-12 pr-4 py-3 sm:py-4 bg-gray-800/50 border border-gray-600/50 rounded-xl focus:outline-none focus:border-blue-400/60 focus:bg-gray-800/70 transition-all duration-300 text-white placeholder-gray-400 resize-none text-sm sm:text-base"
                    ...
                    <div className="pt-4">
                      <button
                        ...
                        className={cn(
                          "w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-semibold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25 group/submit disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100",
                      ...
                      >
                        {isSubmitting ? (
                          ...
                          <Send className="w-5 h-5 mr-3 group-hover/submit:translate-x-1 transition-transform duration-300" />
                        )}
                        {isSubmitting
                          ? "Sending Message..."
                          : submitStatus === "success"
